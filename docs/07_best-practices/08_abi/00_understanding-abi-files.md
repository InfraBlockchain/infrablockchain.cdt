...
[[info | Built-in Types]]
| InfraBlockchain implements a number of custom built-ins. Built-in types don't need to be described in an ABI file. If you would like to familiarize yourself with InfraBlockchain's built-ins, they are defined [here](https://github.com/InfraBlockchain/infrablockchain/blob/76565937064d5acccb089b50aa8ea797cd92dc82/libraries/chain/abi_serializer.cpp#L90)
...
The following structs are implicit in that a struct was never explicitly defined in the contract. Looking at the [create](https://developers.infrablockchain.com/manuals/eosio.contracts/latest/action-reference/eosio.token/index/#create) action, you'll find two parameters, `issuer` of type `name ` and `maximum_supply` of type `asset`. For brevity this tutorial won't break down every struct, but applying the same logic, you will end up with the following:

### [create](https://developers.infrablockchain.com/manuals/eosio.contracts/latest/action-reference/eosio.token/index/#create)
...
```
### [issue](https://developers.infrablockchain.com/manuals/eosio.contracts/latest/action-reference/eosio.token/index/#issue)
...
```
### [retire](https://developers.infrablockchain.com/manuals/eosio.contracts/latest/action-reference/eosio.token/index/#retire)
...
### [transfer](https://developers.infrablockchain.com/manuals/eosio.contracts/latest/action-reference/eosio.token/index/#transfer)
...
### [close](https://developers.infrablockchain.com/manuals/eosio.contracts/latest/action-reference/eosio.token/index/#close)
...
### [account](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L120)
...
```
Describe the actions of the `eosio.token` contract by aggregating all the public functions described in the `eosio.token` contract's [header file](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp).
...
##  [create](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L35-L37)
...
## [issue](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L45-L46)
...
## [retire](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L55-L56)
...
## [transfer](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L67-L71)
...
## [close](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L96-L97)
...
The eosio.token contract instantiates two tables, [accounts](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L134) and [stat](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L135).

The `accounts` table is an i64 index, based on the [`account` struct](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L120-L124), has a [`uint64` as it's primary key](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L123)
...
The `stat` table is an i64 index, based on the [`currency_stats` struct](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L126-L132), has a [`uint64` as it's primary key](https://github.com/InfraBlockchain/infrablockchain.contracts/blob/master/contracts/eosio.token/include/eosio.token/eosio.token.hpp#L131)
