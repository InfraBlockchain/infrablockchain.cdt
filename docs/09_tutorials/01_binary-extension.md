...
You can find the implementation of `eosio::binary_extension` in the `infrablockchain.cdt` repository in [binary_extension.hpp](https://github.com/InfraBlockchain/infrablockchain.cdt/blob/master/libraries/eosiolib/binary_extension.hpp).
